...
const folder = "img";
const root = `https://medievulpes.github.io/Tarot/${folder}`;
const files = "ABCDEFGHIJKLMNOPQRSTUV";
const ext = "jpg";
const IMAGE_SIZE = 687;

let imageContainer = document.getElementById("images");
let canvas = document.createElement("canvas");
canvas.width = IMAGE_SIZE / 1.21;
...
function resizeImage(image, size = IMAGE_SIZE) {
	...
	ctx.drawImage(image, 0, 0, width, height, 0, 0, size / 1.21, size);
